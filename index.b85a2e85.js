const t=[{path:/.*\/dwf-n2-ejercicio_wizard\/welcome/,component:function(t){let e=document.createElement("div");e.innerHTML=` 
        ...
        `;let o=e.querySelector("welcome-form"),n=o?.shadowRoot?.querySelector("form");return n?.addEventListener("submit",e=>{e.preventDefault(),t.goTo("/dwf-n2-ejercicio_wizard/form")}),e}},{path:/.*\/dwf-n2-ejercicio_wizard\/form/,component:function(t){let e=document.createElement("div");e.innerHTML=`  
      <custom-header></custom-header>
      <div class="content-container">
      ...
      <custom-footer></custom-footer>
        `;let o=e.querySelector("greeting-form"),n=o?.shadowRoot?.querySelector("form");n?.addEventListener("submit",e=>{e.preventDefault(),t.goTo("/dwf-n2-ejercicio_wizard/thankyou")});let s=e.querySelector("return-button")?.shadowRoot?.querySelector("button");return s?.addEventListener("click",()=>t.goTo("/welcome")),e}},{path:/.*\/dwf-n2-ejercicio_wizard\/thankyou/,component:function(t){let e=document.createElement("div");e.innerHTML=` 
    <custom-header></custom-header>
    <div class="content-container">
...
//# sourceMappingURL=index.b85a2e85.js.map
