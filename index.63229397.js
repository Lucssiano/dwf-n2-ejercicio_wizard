const t=[{path:/\/welcome/,component:function(t){let e=document.createElement("div");e.innerHTML=` 
        ...
        `;let o=e.querySelector("welcome-form"),n=o?.shadowRoot?.querySelector("form");return n?.addEventListener("submit",e=>{e.preventDefault(),t.goTo("/form")}),e}},{path:/\/form/,component:function(t){let e=document.createElement("div");e.innerHTML=`  
      <custom-header></custom-header>
      <div class="content-container">
    ...
    `}}customElements.define("custom-greeting",s);class i extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}render(){this.shadow.innerHTML=`
		...
		`;let t=document.createElement("style");t.textContent=`
			...
			`,t.appendChild(o),t.appendChild(e)}}customElements.define("custom-footer",l),function(){let e=document.querySelector(".root");e&&function(e){function o(t){history.pushState({},"",t),n(t)}function n(n){for(let s of t)if(s.path.test(n)){let t=s.component({goTo:o});e.firstChild&&e.firstChild.remove(),e.appendChild(t)}}"/"===location.pathname?o("/welcome"):n(location.pathname),window.onpopstate=()=>n(location.pathname)}(e)}();
//# sourceMappingURL=index.63229397.js.map
